...
-   **`WakeWord`**: Detects keywords (e.g., "你好，Alfredo", "Hi, ESP") from the audio stream. It runs independently from the main audio processor until a wake word is detected.
